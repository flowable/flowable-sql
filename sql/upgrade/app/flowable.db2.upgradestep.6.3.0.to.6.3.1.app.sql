CREATE TABLE ".ACT_APP_DATABASECHANGELOGLOCK (ID INTEGER NOT NULL, LOCKED BOOLEAN NOT NULL, LOCKGRANTED TIMESTAMP, LOCKEDBY VARCHAR(255), CONSTRAINT PK_DBCHGLOGLOCK PRIMARY KEY (ID));

DELETE FROM ".ACT_APP_DATABASECHANGELOGLOCK;

INSERT INTO ".ACT_APP_DATABASECHANGELOGLOCK (ID, LOCKED) VALUES (1, FALSE);

UPDATE ".ACT_APP_DATABASECHANGELOGLOCK SET LOCKED = TRUE, LOCKEDBY = 'Tijs-new-macbook-pro.local (192.168.68.127)', LOCKGRANTED = CURRENT TIMESTAMP WHERE ID = 1 AND LOCKED = FALSE;
